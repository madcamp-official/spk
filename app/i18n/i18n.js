...
"사인":["Cause of death","死因","死因","Causa de muerte","Causa da morte"],
"심장병":["Heart disease","心臓病","心脏病","Enfermedad cardíaca","Doença cardíaca"],
"암":["Cancer","がん","癌症","Cáncer","Câncer"],
"뇌졸중":["Stroke","脳卒中","中风","Ictus","AVC"],
"호흡기 질환":["Respiratory disease","呼吸器疾患","呼吸系统疾病","Enfermedad respiratoria","Doença respiratória"],
"당뇨 합병증":["Diabetes","糖尿病の合併症","糖尿病并发症","Diabetes","Diabetes"],
"간 질환":["Liver disease","肝疾患","肝病","Enfermedad hepática","Doença hepática"],
"감염병":["Infectious disease","感染症","传染病","Enfermedad infecciosa","Doença infecciosa"],
"사고":["Accident","事故","意外事故","Accidente","Acidente"],
"치매":["Dementia","認知症","痴呆症","Demencia","Demência"],
"노환":["Old age","老衰","衰老","Vejez","Velhice"],
...
"희귀":["Rare","レア","稀有","Raro","Raro"],
"영웅":["Epic","エピック","史诗","Épico","Épico"],
"전설":["Legendary","レジェンド","传说","Legendario","Lendário"],
"신화":["Mythic","神話","神话","Mítico","Mítico"],
};
