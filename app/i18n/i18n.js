...
/* ── 첫 화면: 헤더의 모두의 환생 횟수(counter.js) · 실시간 환생 티커(ticker.js) ── */
...
"방금 {flag} {country}에서 누군가 태어났어요":["{flag} Someone was just born in {country}","たった今 {flag} {country}で誰かが生まれました","刚刚 {flag} 有人在{country}出生了","{flag} Alguien acaba de nacer en {country}","{flag} Alguém acabou de nascer em {country}"],
"{flag} {country}에서 누군가 태어났어요 · {n}초 전":["{flag} Someone was born in {country} · {n}s ago","{flag} {country}で誰かが生まれました · {n}秒前","{flag} 有人在{country}出生了 · {n}秒前","{flag} Alguien nació en {country} · hace {n}s","{flag} Alguém nasceu em {country} · há {n}s"],
