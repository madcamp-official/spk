...
export const RARITY_SCORE = {
  ...
  countryWeight: 1 as number | null,
  /** 생 극단성에 걸 지수. 1 = 그대로 반영 */
  lifeWeight: 1 as number | null,
  /** 합성에 쓸 축과 비중. 키는 국가 평균이 있어 "국가 내 백분위"를 낼 수 있는 축만.
   *  소득·수명은 서사에 크게 걸려 동등하게, 키는 절반만 준다. */
  axisWeights: { lifeExp: 1, income: 1, iq: 1, height: 0.5 } as Record<string, number> | null,
} as const;
