...
import {rarityColor,iqTopPct} from "../../core/roll.js";
...
/* 화면 배지와 결과 카드(share.js drawCard)가 같은 목록을 쓴다 */
export function lifeBadges(l){
 const badges=[];
...
export function recordLife(l){
 ...
 /* 이번 생의 지표(IQ·키·몸무게·종교·민족…)를 업적용으로 남긴다. persist() 전에 불러야 저장된다. */
 noteLife(l);
